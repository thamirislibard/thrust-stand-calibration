...
próprio aprovado pelo Colegiado da FCTE. Os alunos matriculados nessas 
...
o aluno deve apresentar na Secretaria da FCTE, uma cópia para cada membro da 
Banca Examinadora.

Após a aprovação em TCC2, o aluno deverá obrigatoriamente apresentar a 
versão final de seu trabalho à Secretaria da FCTE na seguinte forma:

\begin{itemize}
	\item 01 cópia encadernada para arquivo na FCTE;
	\item 01 cópia não encadernada (folhas avulsas) para arquivo na FCTE;
